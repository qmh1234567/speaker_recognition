...
class X_Vector():
    ...
    def x_vector(self,input_shape):
        ...
        # x = self.residual_block(x,outdim=256,stride=(2,2),name='block4')
        
        x = self.residual_block(x,outdim=512,stride=(2,2),name='block6')
        
        # x = self.residual_block(x,outdim=512,stride=(2,2),name='block7')###
        
        # x = self.residual_block(x,outdim=512,stride=(2,2),name='block8')
        
        # x = self.residual_block(x,outdim=512,stride=(2,2),name='block9')
